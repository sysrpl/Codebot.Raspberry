...
namespace Raspberry.Board
{
    ...
    public sealed class GpioController : IDisposable
    {
        ...
        public void ClosePin(int pinNumber)
        {
            ...
            if (!_openPins.Contains(logicalPinNumber))
            {
                throw new InvalidOperationException("Cannot close a pin that is not open.");
            }
        ...
        public void SetPinMode(int pinNumber, PinMode mode)
        {
            ...
            if (!_openPins.Contains(logicalPinNumber))
            {
                throw new InvalidOperationException("Cannot set a mode to a pin that is not open.");
            }
        ...
        public PinMode GetPinMode(int pinNumber)
        {
            ...
            if (!_openPins.Contains(logicalPinNumber))
            {
                throw new InvalidOperationException("Cannot get the mode of a pin that is not open.");
            }
        ...
        public PinValue Read(int pinNumber)
        {
            ...
            if (!_openPins.Contains(logicalPinNumber))
            {
                throw new InvalidOperationException("Cannot read from a pin that is not open.");
            }
        ...
        public void Write(int pinNumber, PinValue value)
        {
            ...
            if (!_openPins.Contains(logicalPinNumber))
            {
                throw new InvalidOperationException("Cannot write to a pin that is not open.");
            }
        ...
        public WaitForEventResult WaitForEvent(int pinNumber, PinEventTypes eventTypes, CancellationToken cancellationToken)
        {
            ...
            if (!_openPins.Contains(logicalPinNumber))
            {
                throw new InvalidOperationException("Cannot wait for events from a pin that is not open.");
            }
        ...
        public void RegisterCallbackForPinValueChangedEvent(int pinNumber, PinEventTypes eventTypes, PinChangeEventHandler callback)
        {
            ...
            if (!_openPins.Contains(logicalPinNumber))
            {
                throw new InvalidOperationException("Cannot add callback for a pin that is not open.");
            }
        ...
        public void UnregisterCallbackForPinValueChangedEvent(int pinNumber, PinChangeEventHandler callback)
        {
            ...
            if (!_openPins.Contains(logicalPinNumber))
            {
                throw new InvalidOperationException("Cannot remove callback for a pin that is not open.");
            }
